...
public class ArticleController {
    ...
    @Autowired
    public ArticleController(ArticleService ArticleService, JwtUtil JwtUtil, UtilisateurRepository UtilisateurRepository, SiteRepository siteRepository, ArticleRepository articleRepository) {
  ...
  public ResponseEntity<?> getMyArticles(@RequestHeader("Authorization") String token) {
    ...
    public ResponseEntity<?> getArticleById(@PathVariable int id) {
        try {
            ...
            System.out.println(article.get().getNomA());
